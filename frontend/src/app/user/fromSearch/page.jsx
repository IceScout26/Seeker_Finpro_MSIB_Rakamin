...
export default async function FromSearch() {
    ...
    return (
        <div className="container h-full w-full bg-white">
            ...
            <div>
                <h1 className="text-lg font-semibold ml-36 mb-4 text-black">FRONTEND</h1>
            </div>
            <div className="flex">
                <div className="w-96 row border-2 p-9 ml-32 border-black rounded-3xl bg-gray-100 shadow-xl cursor-pointer mr-4">
                    <h1 className="text-base font-semibold ml-0 mb-4 text-black">PT Rakamin Academy</h1>
                    <div className='flex'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <div>
                                ...
                                <div>
                                    <h1 className="text-xs font-semibold ml-9 -mt-7 mb-0 text-black">FRONTEND</h1>
                                </div>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 40 40" fill="none">
                                ...
                                <div>
                                    <h1 className="text-xs font-semibold ml-9 -mt-7 mb-0 text-black">Bandung, west java</h1>
                                </div>
                            </div>
                            <div>
                                ...
                                <div>
                                    <h1 className="text-xs font-semibold ml-9 -mt-7 mb-0 text-black">2023-10-20</h1>
                                </div>
                            </div>
                        </div>
                    </div>
